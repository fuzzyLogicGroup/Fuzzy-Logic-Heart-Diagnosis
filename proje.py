...
print("\n\n------------------------------------Welcome-----------------------------------------\n\n")
print("Enter health data to calculate the risk of heart disease with Fuzzy Logic...\n\n")
...
print("\n\nThank you for the entered values.")
print("\n\nCalculations are being performed. Please wait...\n\n")
